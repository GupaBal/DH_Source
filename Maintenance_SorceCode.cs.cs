    ...
    public partial class AceControl : UserControl
    {
        ...
        private void ProcessData(bool mode)
        {
            ...
            for (int t = 0; t < ProcessCnt; t++)
            {
                ...
                rm.Init_Excel_Report(Files_FullName, "유지관리이력");
                //      
                ...
                // report_file.Init_Excel_Report(@"E:\동해\추가자료\추가작업용\1.역사기초\1. 역사_기초.xlsx", "기초");
                ...
                string stringcompare15 = "";
                string stringcompare16 = "";
                string stringcompare17 = "";
                string stringcompare18 = "";
                string stringcompare19 = "";
                string stringcompare20 = "";
                string stringcompare21 = "";
                ...
                string[] temp5 = new string[100];
                string[] temp6 = new string[100];
                string[] temp7 = new string[100];
                ...
                while (stopflag != false)
                {
                    ...
                    if (start_key == 5)
                    {
                        ...
                        stringArray1[3] = rm.GetData(tempVal1, 3) == null ? null : rm.GetData(tempVal1, 3).ToString();
                        stringArray1[4] = rm.GetData(tempVal1, 4) == null ? null : rm.GetData(tempVal1, 4).ToString();
                        stringArray1[5] = rm.GetData(tempVal1, 5) == null ? null : rm.GetData(tempVal1, 5).ToString();
                        stringArray1[6] = rm.GetData(tempVal1, 6) == null ? null : rm.GetData(tempVal1, 6).ToString();

                        if ((null != stringArray1[3] || null != stringArray1[4] || null != stringArray1[5] || null != stringArray1[6]) &&  stop1 != 1)
                        {
                            stringArray1[0] = rm.GetData(tempVal1, 1) == null ? null : rm.GetData(tempVal1, 1).ToString();
                            stringArray1[1] = rm.GetData(tempVal1, 2) == null ? null : rm.GetData(tempVal1, 2).ToString();
                            stringArray1[2] = rm.GetData(tempVal1, 3) == null ? null : rm.GetData(tempVal1, 3).ToString();
                            stringArray1[93] = rm.GetData(tempVal1, 4) == null ? null : rm.GetData(tempVal1, 4).ToString();
                            stringArray1[94] = rm.GetData(tempVal1, 5) == null ? null : rm.GetData(tempVal1, 5).ToString();
                            stringArray1[5] = rm.GetData(tempVal1, 6) == null ? null : rm.GetData(tempVal1, 6).ToString();
                            stringArray1[6] = rm.GetData(tempVal1, 7) == null ? null : rm.GetData(tempVal1, 7).ToString();
                            stringArray1[7] = rm.GetData(tempVal1, 8) == null ? null : rm.GetData(tempVal1, 8).ToString();
                            stringArray1[8] = rm.GetData(tempVal1, 9) == null ? null : rm.GetData(tempVal1, 9).ToString();

                            stringcompare13 = stringArray1[93];
                            stringcompare14 = stringArray1[94];
                            if (stringcompare13 != null )
                            {                        
                             stringArray1[3] = stringcompare13.Replace("-", "");
                           
                            }if(stringcompare14 != null)
                            {
                                stringArray1[4] = stringcompare14.Replace("-", "");
                            }


                            for (int i = 0; i < 9; i++)
                            {
                                if (stringArray1[i] == null)
                                {
                                    stringArray1[i] = "자료없음";
                                }
                            }
                        ...
                        {
                            stringArray1[10] = rm.GetData(tempVal1, 10) == null ? null : rm.GetData(tempVal1, 10).ToString();
                            stringArray1[12] = rm.GetData(tempVal1, 12) == null ? null : rm.GetData(tempVal1, 12).ToString();
                            stringArray1[13] = rm.GetData(tempVal1, 13) == null ? null : rm.GetData(tempVal1, 13).ToString();
                            stringArray1[14] = rm.GetData(tempVal1, 14) == null ? null : rm.GetData(tempVal1, 14).ToString();
                            stringArray1[15] = rm.GetData(tempVal1, 15) == null ? null : rm.GetData(tempVal1, 15).ToString();
                            stringArray1[16] = rm.GetData(tempVal1, 16) == null ? null : rm.GetData(tempVal1, 16).ToString();
                            stringArray1[17] = rm.GetData(tempVal1, 17) == null ? null : rm.GetData(tempVal1, 17).ToString();

                          

                            if (stringArray1[10] != null || stringArray1[13] != null || stringArray1[14] != null || stringArray1[15] != null || stringArray1[16] != null || stringArray1[17] != null)
                            {
                               // tempVal1++;
                                tempVal2 = +tempVal1;
                                stop1++;
                            ...
                            else
                            {
                                ...
                                stringArray1[1] = rm.GetData(tempVal1, 2) == null ? null : rm.GetData(tempVal1, 2).ToString();
                                stringArray1[2] = rm.GetData(tempVal1, 3) == null ? null : rm.GetData(tempVal1, 3).ToString();
                                stringArray1[3] = rm.GetData(tempVal1, 4) == null ? null : rm.GetData(tempVal1, 4).ToString();
                                stringArray1[4] = rm.GetData(tempVal1, 5) == null ? null : rm.GetData(tempVal1, 5).ToString();
                                stringArray1[5] = rm.GetData(tempVal1, 6) == null ? null : rm.GetData(tempVal1, 6).ToString();
                                stringArray1[6] = rm.GetData(tempVal1, 7) == null ? null : rm.GetData(tempVal1, 7).ToString();
                                stringArray1[7] = rm.GetData(tempVal1, 8) == null ? null : rm.GetData(tempVal1, 8).ToString();
                                stringArray1[8] = rm.GetData(tempVal1, 9) == null ? null : rm.GetData(tempVal1, 9).ToString();
                    ...
                    if ((start_key == 4))
                    {
                     ...
                     //   stringArray1[11] = "";
                        ...
                        stringArray1[10] = rm.GetData(tempVal2, 11) == null ? null : rm.GetData(tempVal2, 11).ToString();
              
                        stringArray1[12] = rm.GetData(tempVal2, 13) == null ? null : rm.GetData(tempVal2, 13).ToString();
                        stringArray1[13] = rm.GetData(tempVal2, 14) == null ? null : rm.GetData(tempVal2, 14).ToString();
                        stringArray1[14] = rm.GetData(tempVal2, 15) == null ? null : rm.GetData(tempVal2, 15).ToString();
                        stringArray1[15] = rm.GetData(tempVal2, 16) == null ? null : rm.GetData(tempVal2, 16).ToString();
                        stringArray1[16] = rm.GetData(tempVal2, 17) == null ? null : rm.GetData(tempVal2, 17).ToString();
                        stringArray1[17] = rm.GetData(tempVal2, 18) == null ? null : rm.GetData(tempVal2, 18).ToString();

                        // stringcompare10 = stringcompare9.Substring(4, 1);

                        if (stringArray1[10] != null || stringArray1[12] != null || stringArray1[13] != null || stringArray1[14] != null || stringArray1[15] != null || stringArray1[16] != null || stringArray1[17] != null)

                        {

                            stringArray1[0] = rm.GetData(tempVal2, 1) == null ? null : rm.GetData(tempVal2, 1).ToString();
                            stringArray1[1] = rm.GetData(tempVal2, 2) == null ? null : rm.GetData(tempVal2, 2).ToString();
                          //  stringArray1[9] = rm.GetData(tempVal2, 10) == null ? null : rm.GetData(tempVal2, 10).ToString();
                            stringArray1[9] = rm.GetData(tempVal2, 10) == null ? null : rm.GetData(tempVal2, 10).ToString();
                            stringArray1[90] = rm.GetData(tempVal2, 12) == null ? null : rm.GetData(tempVal2, 12).ToString();
                            stringArray1[12] = rm.GetData(tempVal2, 13) == null ? null : rm.GetData(tempVal2, 13).ToString();
                            stringArray1[13] = rm.GetData(tempVal2, 14) == null ? null : rm.GetData(tempVal2, 14).ToString();
                            stringArray1[14] = rm.GetData(tempVal2, 15) == null ? null : rm.GetData(tempVal2, 15).ToString();
                            stringArray1[15] = rm.GetData(tempVal2, 16) == null ? null : rm.GetData(tempVal2, 16).ToString();
                            stringArray1[16] = rm.GetData(tempVal2, 17) == null ? null : rm.GetData(tempVal2, 17).ToString();
                            stringArray1[17] = rm.GetData(tempVal2, 18) == null ? null : rm.GetData(tempVal2, 18).ToString();
                            stringArray1[18] = rm.GetData(tempVal2, 19) == null ? null : rm.GetData(tempVal2, 19).ToString();
                            stringcompare11 = stringArray1[90];

                            if (stringcompare11 != null)
                            {
                                stringcompare8 = stringcompare11.Replace("-", "");
                                temp1 = stringcompare8.Split('~');
                                stringArray1[11] = temp1[0];
                                stringArray1[10] = temp1[1];
                            }
                            for (int i = 9; i < 19; i++)
                            {
                                if (stringArray1[i] == null)
                    ...
                    */
                    ...
                    /////////////////////////////////////////////////////////////////////////////////////////////////////////  
                    if (("성능개선공사실적" == rm.GetData(intVal3, 20).ToString()) && (start_key == 3))
                        {
                            #region [ # 성능개선공사실적 ]
                            ...
                            stringArray1[97] = rm.GetData(tempVal3, 31) == null ? null : rm.GetData(tempVal3, 31).ToString();
                            stringArray1[98] = rm.GetData(tempVal3, 33) == null ? null : rm.GetData(tempVal3, 33).ToString();
                            stringArray1[99] = rm.GetData(tempVal3, 35) == null ? null : rm.GetData(tempVal3, 35).ToString();

                          if (stringArray1[97] != null || stringArray1[98] != null || stringArray1[99] != null)
                            {
                              //  tempVal3++;
                                tempVal4 = +tempVal3;
                                // stop2++;
                            ...
                            if (stringArray1[97] == null && stringArray1[98] == null && stringArray1[99] == null)
                            {
                                stringArray1[0] = rm.GetData(tempVal3, 1) == null ? null : rm.GetData(tempVal3, 1).ToString();
                                stringArray1[1] = rm.GetData(tempVal3, 2) == null ? null : rm.GetData(tempVal3, 2).ToString();

                                stringArray1[19] = rm.GetData(tempVal3, 20) == null ? null : rm.GetData(tempVal3, 20).ToString();
                                stringArray1[20] = rm.GetData(tempVal3, 21) == null ? null : rm.GetData(tempVal3, 21).ToString();
                                stringArray1[21] = rm.GetData(tempVal3, 22) == null ? null : rm.GetData(tempVal3, 22).ToString();
                                stringArray1[22] = rm.GetData(tempVal3, 23) == null ? null : rm.GetData(tempVal3, 23).ToString();
                                stringArray1[23] = rm.GetData(tempVal3, 24) == null ? null : rm.GetData(tempVal3, 24).ToString();
                                stringArray1[24] = rm.GetData(tempVal3, 25) == null ? null : rm.GetData(tempVal3, 25).ToString();
                                stringArray1[25] = rm.GetData(tempVal3, 26) == null ? null : rm.GetData(tempVal3, 26).ToString();
                                stringArray1[26] = rm.GetData(tempVal3, 27) == null ? null : rm.GetData(tempVal3, 27).ToString();
                                stringArray1[27] = rm.GetData(tempVal3, 28) == null ? null : rm.GetData(tempVal3, 28).ToString();
                                stringArray1[28] = rm.GetData(tempVal3, 29) == null ? null : rm.GetData(tempVal3, 29).ToString();
                        ...
                        if (("점검진단투입비용 및 안전등급 이력" == rm.GetData(intVal4, 30).ToString()) && (start_key == 2))
                        {
                            #region [ # 점검진단투입비용 및 안전등급 이력]
                     

                            stringArray1[30] = rm.GetData(tempVal4, 31) == null ? null : rm.GetData(tempVal4, 31).ToString();
                           
                            stringArray1[32] = rm.GetData(tempVal4, 33) == null ? null : rm.GetData(tempVal4, 33).ToString();
                            stringArray1[33] = rm.GetData(tempVal4, 34) == null ? null : rm.GetData(tempVal4, 34).ToString();
                            stringArray1[34] = rm.GetData(tempVal4, 35) == null ? null : rm.GetData(tempVal4, 35).ToString();
                            stringArray1[35] = rm.GetData(tempVal4, 36) == null ? null : rm.GetData(tempVal4, 36).ToString();
                            stringArray1[36] = rm.GetData(tempVal4, 37) == null ? null : rm.GetData(tempVal4, 37).ToString();
                        //    stringcompare4 = stringcompare3.Substring(0, 2);
                        //  stringcompare12 = rm.GetData(tempVal4, 3) == null ? null : rm.GetData(tempVal4, 3).ToString();
                        if (stringArray1[30] == null && stringArray1[32] == null && stringArray1[33] == null && stringArray1[34] == null && stringArray1[35] == null && stringArray1[36] == null)
                            {
                            ...
                            { 
                                ...
                                stringArray1[0] = rm.GetData(tempVal4, 1)== null ? null : rm.GetData(tempVal4, 1).ToString();
                                stringArray1[1] = rm.GetData(tempVal4, 2)== null ? null : rm.GetData(tempVal4, 2).ToString();
                                    stringcompare15 = rm.GetData(tempVal4, 30) == null ? null : rm.GetData(tempVal4, 30).ToString();
                                // stringArray1[30] = rm.GetData(tempVal4, 31) == null ? null : rm.GetData(tempVal4, 31).ToString();
                                stringArray1[31] = rm.GetData(tempVal4, 32) == null ? null : rm.GetData(tempVal4, 32).ToString();
                                stringArray1[32] = rm.GetData(tempVal4, 33) == null ? null : rm.GetData(tempVal4, 33).ToString();
                                stringArray1[33] = rm.GetData(tempVal4, 34) == null ? null : rm.GetData(tempVal4, 34).ToString();
                                stringArray1[34] = rm.GetData(tempVal4, 35) == null ? null : rm.GetData(tempVal4, 35).ToString();
                                stringArray1[35] = rm.GetData(tempVal4, 36) == null ? null : rm.GetData(tempVal4, 36).ToString();
                            ...
                            if(stringcompare15 != null )
                            { 
                                stringcompare16 = stringcompare15.Replace("-", "");
                                temp4 = stringcompare16.Split('~');
                                stringArray1[29] = temp4[0];
                                stringArray1[30] = temp4[1];
                            }
                        ...
                        stringArray1[0] = rm.GetData(tempVal5, 1) == null ? null : rm.GetData(tempVal5, 1).ToString();
                        stringArray1[38] = rm.GetData(tempVal5, 39) == null ? null : rm.GetData(tempVal5, 39).ToString();
                        stringArray1[39] = rm.GetData(tempVal5, 40) == null ? null : rm.GetData(tempVal5, 40).ToString();
                        stringArray1[40] = rm.GetData(tempVal5, 41) == null ? null : rm.GetData(tempVal5, 41).ToString();

                        if (null != stringArray1[38] || null != stringArray1[39] || null != stringArray1[40])
                        {
                            //    stringArray1[0] = rm.GetData(intVal6, 6) == null ? null : rm.GetData(intVal6, 6).ToString();
                            stringArray1[0] = rm.GetData(tempVal5, 1) == null ? null : rm.GetData(tempVal5, 1).ToString();
                            stringArray1[1] = rm.GetData(tempVal5, 2) == null ? null : rm.GetData(tempVal5, 2).ToString();
                            stringArray1[37] = rm.GetData(tempVal5, 38) == null ? null : rm.GetData(tempVal5, 38).ToString();
                            stringArray1[38] = rm.GetData(tempVal5, 39) == null ? null : rm.GetData(tempVal5, 39).ToString();
                            stringArray1[39] = rm.GetData(tempVal5, 40) == null ? null : rm.GetData(tempVal5, 40).ToString();
                            stringArray1[40] = rm.GetData(tempVal5, 41) == null ? null : rm.GetData(tempVal5, 41).ToString();
                        ...
                        if ((null == stringArray1[38] && null == stringArray1[39] && null == stringArray1[40]) && stringArray1[0] != null)
                        {
                            stringArray1[0] = rm.GetData(tempVal5, 1) == null ? null : rm.GetData(tempVal5, 1).ToString();
                            stringArray1[1] = rm.GetData(tempVal5, 2) == null ? null : rm.GetData(tempVal5, 2).ToString();
                            stringArray1[37] = rm.GetData(tempVal5, 38) == null ? null : rm.GetData(tempVal5, 38).ToString();
                        ...
                        string pathaddress1 = @"C:\Users\APROS-1\Desktop\2019.12.24  유지관리완료\05. 건축물(데이터작업중)\모든건축물";
                        string[] Files_List1 = new string[300];
